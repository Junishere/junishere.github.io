...
function drawPacmanDying(x,y,frame) {
    ...
    if (frame == 1) {
        ...
        ctx.fillRect(1*UNIT,7*UNIT,4*UNIT,1*UNIT);
        ctx.fillRect(12*UNIT,7*UNIT,4*UNIT,1*UNIT);
        ctx.fillRect(1*UNIT,8*UNIT,15*UNIT,2*UNIT);
        ctx.fillRect(2*UNIT,10*UNIT,13*UNIT,1*UNIT);
        ...
        ctx.fillRect(1*UNIT,7*UNIT,15*UNIT,2*UNIT);
        ctx.fillRect(2*UNIT,9*UNIT,13*UNIT,1*UNIT);
        ...
        ctx.fillRect(5*UNIT,6*UNIT,7*UNIT,1*UNIT);
        ctx.fillRect(2*UNIT,7*UNIT,13*UNIT,1*UNIT);
        ctx.fillRect(1*UNIT,8*UNIT,15*UNIT,1*UNIT);
        ctx.fillRect(2*UNIT,9*UNIT,6*UNIT,1*UNIT);
        ctx.fillRect(9*UNIT,9*UNIT,6*UNIT,1*UNIT);
        ctx.fillRect(4*UNIT,10*UNIT,3*UNIT,1*UNIT);
        ctx.fillRect(10*UNIT,10*UNIT,3*UNIT,1*UNIT);
    } else if (frame == 8) {
        ctx.fillRect(8*UNIT,4*UNIT,1*UNIT,1*UNIT);
        ctx.fillRect(7*UNIT,5*UNIT,3*UNIT,1*UNIT);
        ctx.fillRect(5*UNIT,6*UNIT,7*UNIT,1*UNIT);
        ctx.fillRect(4*UNIT,7*UNIT,9*UNIT,1*UNIT);
        ctx.fillRect(2*UNIT,8*UNIT,13*UNIT,1*UNIT);
        ctx.fillRect(2*UNIT,9*UNIT,6*UNIT,1*UNIT);
        ctx.fillRect(9*UNIT,9*UNIT,6*UNIT,1*UNIT);
        ctx.fillRect(3*UNIT,10*UNIT,4*UNIT,1*UNIT);
        ctx.fillRect(10*UNIT,10*UNIT,4*UNIT,1*UNIT);
    } else if (frame == 9) {
        ctx.fillRect(8*UNIT,4*UNIT,1*UNIT,1*UNIT);
        ctx.fillRect(7*UNIT,5*UNIT,3*UNIT,1*UNIT);
        ctx.fillRect(6*UNIT,6*UNIT,5*UNIT,2*UNIT);
        ctx.fillRect(5*UNIT,8*UNIT,7*UNIT,1*UNIT);
        ctx.fillRect(4*UNIT,9*UNIT,9*UNIT,1*UNIT);
        ctx.fillRect(5*UNIT,10*UNIT,3*UNIT,1*UNIT);
        ctx.fillRect(9*UNIT,10*UNIT,3*UNIT,1*UNIT);
    } else if (frame == 10) {
        ctx.fillRect(8*UNIT,4*UNIT,1*UNIT,2*UNIT);
        ctx.fillRect(7*UNIT,6*UNIT,3*UNIT,3*UNIT);
        ...
        ctx.fillRect(8*UNIT,4*UNIT,1*UNIT,6*UNIT);
    } else if (frame == 12) {
        ...
        ctx.fillRect(3*UNIT,5*UNIT,2*UNIT,1*UNIT);
